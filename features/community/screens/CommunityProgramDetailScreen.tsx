...
import { ArrowLeft, MapPin, Share2, Mail, Clock, Users } from "lucide-react-native";
...
export function CommunityProgramDetailScreen({
  programId,
  onBack,
}: CommunityProgramDetailScreenProps) {
  const program = useMemo(
    () => communityPrograms.find((p) => p.id === programId) || communityPrograms[0],
    [programId]
  );
        ...
        <View className="bg-white rounded-t-3xl px-4 pt-6 pb-6">
          ...
          <View className="flex-row items-center gap-2 mb-6">
            <View className="px-3 py-1 rounded-full bg-green-100">
              <Text className="text-xs font-semibold text-green-700">Active Program</Text>
            </View>
          </View>
          ...
          <View className="gap-4 mb-6">
            ...
            <View className="flex-row items-start gap-3">
              ...
              <View className="flex-1">
                ...
                <Text className="text-sm text-gray-600">Grace Community Church</Text>
              </View>
            </View>
          </View>
          ...
          {/* Description */}
          <View className="mb-6">
            <Text className="font-semibold text-gray-900 mb-2">About This Program</Text>
            ...
            <Text className="text-sm text-gray-600 leading-6 mt-3">
              This program serves over 200 families each month, providing essential food items
              and groceries. We welcome volunteers and donations to continue this vital ministry.
            </Text>
          </View>

          {/* Coordinator Contact */}
          <View className="mb-6 p-4 bg-gray-50 rounded-xl">
            <Text className="font-semibold text-gray-900 mb-2">Program Coordinator</Text>

            <Pressable onPress={() => {}} className="flex-row items-center gap-2">
          ...
          {/* How to Help */}
          <View className="mb-2">
            <Text className="font-semibold text-gray-900 mb-3">How You Can Help</Text>
