              ...
              <View className='flex-row gap-2'>
                {/* <Pressable
                  ...
                  className={`w-10 h-10 rounded-full items-center justify-center ${
                    isFollowing ? 'bg-red-500' : 'bg-white/90'
                  }`}
                >
                  <Heart
                    size={20}
          ...
          <View className='absolute bottom-4 left-4 right-4'>
            ...
            <View className='flex-row items-center gap-2 '>
              ...
              <Pressable
                ...
                isFollowing ? 'bg-red-500' : 'bg-white/50'
                }`}
              >
                <Heart
                size={12}
              ...
              <Pressable className='w-6 h-6 bg-white/50 rounded-full items-center justify-center'>
                <Share2 size={12} color='#111827' />
              </Pressable>
              </View>
            </View>
          </View>
        ...
        <View className='px-4 py-4'>
                ...
                <Card key={index}>
                  <CardContent>
                    <View className='flex-row items-center gap-4'>
                      <Avatar src={member.photo} alt={member.name} size='lg' />
                      <View className='flex-1'>
                        <Text className='font-semibold text-gray-900'>
                          {member.name}
                        </Text>
            ...
            <View className='gap-4'>
              <Card>
                <CardContent className='items-center py-8'>
                  ...
                  <Text className='text-gray-500 mt-3'>No upcoming events</Text>
                </CardContent>
              </Card>
            </View>
          )}
          ...
          {activeTab === 'Give' && (
            <View className='gap-4'>
              <Card>
                <CardContent>
                  <View className='items-center py-4'>
                    ...
                    Your generous giving helps us continue serving our community, supporting missions, and spreading the
              ...
              <Card>
                <CardContent>
                  <Text className="text-sm font-medium text-gray-900 mb-3">Select Donation Type</Text>

                  <View className="flex-row flex-wrap mb-4 -mx-1">
                    {["Tithe", "Offering", "Missions", "Building Fund", "Stewardship", "Pledge"].map((type) => {
                       const active = donations.type === type;
                      return (
                      <View key={type} className="w-1/2 px-1 mb-2">
                        <Pressable onPress={() => setDonations({...donations, type: type})}
                          className={`flex-1 py-2 rounded-lg border-2 items-center ${
                            active ? "border-indigo-600 bg-indigo-50" : "border-gray-200"
                          }`}>
                          <Text className="text-sm text-gray-900 font-medium">{type}</Text>
                        </Pressable>
                      </View>
                    )})}
                  </View>
              ...
              <Card>
                <CardContent>
                  <Text className="text-sm font-medium text-gray-900 mb-3">Amount</Text>
                  ...
                  <View className="flex-row gap-2 mb-3">
                    {[25, 50, 100, 250].map((amt) => {
                      ...
                      return (
                        ...
                        >
                          <Text className={`font-medium ${active ? "text-indigo-600" : "text-gray-900"}`}>
                            ${amt}
                          </Text>
                        </Pressable>
                      );
              ...
              <Button className="w-full" size="lg">
                <View className="flex-row items-center justify-center gap-2">
                  ...
                  <Text className="text-white font-semibold">Give ${donations.amount}</Text>
                </View>
              </Button>

              <Pressable className="items-center">
                <Text className="text-sm text-indigo-600">View Donation Receipt History</Text>
              </Pressable>
            </View>
            </View>
          )}
