...
export function SermonDetailScreen({
  ...
  const related = useMemo(
    () =>
      sermons
        .filter(
          (s) => s.id !== sermon.id && s.speaker === sermon.speaker
        )
        .slice(0, 2),
    [sermon.id, sermon.speaker]
  );
        ...
        <ScrollView contentContainerClassName="pb-28">
          ...
          <View className="relative">
            ...
            <View className="absolute top-4 right-4">
              <Pressable
                onPress={onBack}
                className="h-12 w-12 rounded-2xl bg-white/90 items-center justify-center"
              >
          ...
          <View className="bg-white -mt-6 rounded-t-3xl px-4 pt-6 pb-6">
            ...
            <View className="gap-3 mb-6">
              ...
              <View className="flex-row items-center flex-wrap">
                ...
                <View className="flex-row items-center gap-2">
                  ...
                  <Text className="text-sm text-gray-700">{sermon.duration}</Text>
                </View>
              </View>
            ...
            <View className="mb-6 p-4 bg-gray-50 rounded-2xl border border-gray-200">
              ...
              <Text className="font-medium text-gray-900">{sermon.church}</Text>
            </View>
            ...
            <View className="mb-6">
              ...
              <View className="p-4 bg-gray-50 rounded-2xl border border-gray-200">
                <Text className="text-sm text-gray-700 leading-relaxed mb-3">
                  In this powerful message, {sermon.speaker} explores the theme
                  of {String(sermon.topic).toLowerCase()} and how it applies to
        ...
        <View className="absolute bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-4 py-4">
          <View className="flex-row gap-3">
            ...
            >
              ...
              <Text className="text-white font-semibold ml-2">Play Sermon</Text>
            </Pressable>
          </View>
        </View>
      </View>
