...
const menuSections: MenuSection[] = [
  // About Section
  {
    ...
    items: [
      ...
      { icon: FileText, label: 'History', action: 'history' },
      ...
      { icon: FileText, label: 'Global Church News', action: 'global-church-news' },
  ...
  // Worship Section
  {
    ...
    items: [
      ...
      { icon: FileText, label: 'Worship Online', action: 'worship-online' },
      ...
      { icon: FileText, label: 'Newsletters', action: 'newsletters' },
    ],
  },
  ...
  // Ministries Section
  {
    ...
    items: [
      ...
      { icon: Users, label: 'Church Groups / Bodies', action: 'groups' },
      { icon: Heart, label: 'Pastoral Care', action: 'pastoral-care' },
      {
        icon: Church,
  ...
  // Give / Donate Section
  {
    ...
    icon: DollarSign,
    items: [
      { icon: Heart, label: 'Why We Give', action: 'why-give' },
      { icon: DollarSign, label: 'How to Give', action: 'how-to-give' },
      { icon: DollarSign, label: 'Online Giving', action: 'online-giving' },
      { icon: FileText, label: 'Pledges', action: 'pledges' },
      { icon: FileText, label: 'Receipts', action: 'receipts' },
    ],
  },
  // Events Section
  {
  ...
  // Resources Section
  {
    ...
    items: [
      ...
      { icon: FileText, label: 'Downloads', action: 'downloads' },
